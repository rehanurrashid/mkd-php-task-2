<div class="container mb-5">
                  ...
                  <?php endif; ?><a href="http://localhost/mkd-php-task-2/initialize/" class="btn btn-dark w-50 mt-2 mb-2">See All Models</a><form class="mt-5" method="POST" action="http://localhost/mkd-php-task-2/initialize/model/store/2"><h4>Location:</h4><div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="loc_name" placeholder="Email" name="user_email" required='required'>
                                          ...
                                          </div><input type="hidden" name="input_prefix" value="location,email,sms,user,location,email,sms,user"><button type="submit" class="btn btn-info mt-4">Submit</button>
                    </form>
                    </div>
                  </div>
                </div>